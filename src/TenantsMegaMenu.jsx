...
import Data from "./tenantsMegaMenu";
import InsightsCard from "./InsightsCard";
import "./TenantsMegaMenu.css";

export default function TenantsMegaMenu() {
      ...
      <div className="mega-right">
        ...
        {isCommercial && rightData?.imagePanel && (
          <div
            ...
            onClick={() => handleNavigate(rightData.imagePanel.path)}
          >
            <img src={rightData.imagePanel.image} alt="commercial" />
        ...
        {/* INSIGHTS CARD */}
        {showInsightsCard && rightPanel?.insights && (
