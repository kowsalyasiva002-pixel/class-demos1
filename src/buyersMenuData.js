...
const buyersMegaMenuData = {
  ...
  /* ================= LEFT MENU ================= */
  leftMenu: [
    { id: "buy", label: "BUY A HOME", defaultActive: true },
  ...
  middleContent: {
    ...
    land: {
      title: "PLOTS IN HYDERABAD",
      items: [
        { label: "Gated community plots in Hyderabad", path: "/buy/plots/gated" },
        { label: "Corner Plots in hyderabad", path: "/buy/plots/corner" },
        { label: "East Facing Plots in hyderabad", path: "/buy/plots/east-facing" },
        { label: "Freehold Plots in hyderabad", path: "/buy/plots/freehold" }
      ]
    },
    ...
    articles: {
      title: "ARTICLES & NEWS",
      items: [
        { label: "Articles For Buyers", path: "/articles/buyers" },
...
export default buyersMegaMenuData;
